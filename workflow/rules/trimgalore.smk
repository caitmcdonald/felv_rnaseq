...
rule trimgalore_pe:
    ...
    threads: 19
    shell:
        "echo trim_galore --cores 19 --paired --retain_unpaired --phred33 --length 36 -q 5 --stringency 1 -e 0.1 -o {output.direct} {input.fq1} {input.fq2}"
