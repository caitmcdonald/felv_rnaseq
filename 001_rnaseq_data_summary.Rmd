...
Once this is finished, I'll re-run STAR on the puma samples only, filter the respective read counts matrices to only orthologs, and combine for DGE analysis.
